...
export const ReadingTile = ({ url, title, score, time }: ReadingTileProps) => (
  <a
    ...
    className="flex flex-row justify-between px-2 py-1 border-1 rounded-sm border-velvet-900/60 hover:border-velvet-950/75 bg-velvet-950/50 hover:bg-velvet-1100/20 transition-colors items-center"
